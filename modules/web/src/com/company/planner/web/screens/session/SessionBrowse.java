...
public class SessionBrowse extends StandardLookup<Session> {
    ...
    public void onSessionsCalenderCalendarEventClick(Calendar.CalendarEventClickEvent<LocalDateTime> event) {
        sessionEditDialog.setEntityProvider(() -> (Session) event.getEntity());
        sessionEditDialog.show();
    }

    @Subscribe("sessionsCalender")
    public void onSessionsCalenderCalendarEventMove(Calendar.CalendarEventMoveEvent<LocalDateTime> event) {
